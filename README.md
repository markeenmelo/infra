...
**Nothing has been deployed, formatted, repaired or migrated. ThinkPad's commissioning reviews are recorded; it is a local activation target pending its authorized boot switch and first-boot acceptance. The other hosts remain unready until their transition reviews complete.** Only ready hosts enter `nixosConfigurations`; deploy outputs require readiness plus enabled deployment intent.
