...
**ThinkPad is commissioned and local-only, with its earlier two-boot acceptance recorded. The later maintenance candidate and review fixes have not been activated or booted. The other hosts remain unready until their transition reviews complete.** Only ready hosts enter `nixosConfigurations`; deploy outputs require readiness plus enabled deployment intent.
