{
  fleet.hosts.thinkpad.module = {
    fleet.existingStorage = {
      ...
      # Reviewed preflight 2026-09-10 (ESP/health/console-rescue), not a boot
      # test. Evidence: docs/hosts.md#current-status.
      bootReviewed = true;
      # Operator review 2026-09-10: no-new-backup stance with preserved old
      # root/generations, first-boot regeneration of CUPS/clock/power state,
      # corrected AccountsService backing mode. Evidence: docs/hosts.md.
