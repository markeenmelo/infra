...
| racknerd | `hosts/racknerd.yaml` (retained, no longer selected); enrollment file not supplied | `/persist/var/lib/sops-nix/key.txt`; fresh recovery/early-delivery review passed, installed acceptance pending |
