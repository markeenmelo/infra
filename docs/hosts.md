...
- The initial unprivileged hardware generator could not inspect Btrfs. The later privileged scan succeeded and its module facts are adapted; `hardwareReviewed` remains false pending its suppressed diagnostics and initrd review.
