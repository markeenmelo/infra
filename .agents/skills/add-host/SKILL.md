...
7. Configure real admin public keys, runtime credentials and elevation. Configure interactive users separately from the admin. Resolve user/NAS/VPS-specific review requirements only after actual decisions. Headless laptops need no desktop/gaming acknowledgement; defer those capabilities until requested.
