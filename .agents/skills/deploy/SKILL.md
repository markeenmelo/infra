...
Read `../../../AGENTS.md`, `../../../modules/deployment.nix`, `../../../scripts/fleet/ready.sh`, target metadata, [current host evidence](../fleet-operations/references/hosts.md#current-status) and [operations/recovery](references/operations.md#deployment-and-recovery). Reading this skill authorizes no remote contact.
