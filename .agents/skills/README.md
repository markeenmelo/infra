...
Procedures for this repository. One `SKILL.md` each, no reference trees — the code, scripts and `git log` hold the details.
...
| [devenv](devenv/SKILL.md) | Shell and tasks, local checks, input updates |
| [tailscale](tailscale/SKILL.md) | Clients, tailnet policy, OpenTofu state |
| [desktop](desktop/SKILL.md) | ThinkPad desktop, Home Manager, displays, Wi-Fi |
